...
export { login, logout, signup, getMe } from './auth';
...
export { createBooking, fetchBookings, fetchBookingById, cancelBooking } from './bookings';
export type {
  Booking,
  BookingStatus,
  PaymentStatus,
...
import { login, logout, signup, getMe } from './auth';
import { fetchServices, fetchServiceById } from './services';
import { createBooking, fetchBookings, fetchBookingById, cancelBooking } from './bookings';
...
const api = Object.assign(apiClient, {
  ...
  bookings: { createBooking, fetchBookings, fetchBookingById, cancelBooking },
